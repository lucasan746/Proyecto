...
<article class="frecuente1">
  <h1>Sloth</h1>
  <h3>¿Qué es Sloth?</h3>
  <p>Sloth es una red social que permite subir contenido referido a mascotas y sus dueños. Las personas publican fotos, videos y/o texto. Estas publicaciones se añaden al perfil de cada usuario y pueden ser vistas allí mismo o en la página de inicio por sus seguidores al momento de ser compartida. </p>
</article>

<article class="frecuente1">
  <h3>¿Necesito algo en especial para usar Sloth?</h3>
  <p>Todo lo que necesitas para usar Sloth es una conexión a internet o un teléfono móvil. ¡Únete a nosotros! Una vez que te hayas registrado, podrás comenzar a buscar y a seguir cuentas cuyas publicaciones te interesen. Y nosotros también te recomendaremos cuentas estupendas que te pueden gustar.</p>
</article>
...
<article class="frecuente1">
  ...
  <p>Tus seguidores pueden ver tus publicaciones. Si tus publicaciones son públicas, cualquier persona que busque tu perfil podrá verlas. Los slot son públicos de forma predeterminada. Si tienes dudas sobre la posibilidad de que personas desconocidas vean tu perfil,visita </p><a href="#">privacidad del perfil</a>.
</article>
<article class="frecuente1">
  <h1>Seguir</h1>
...
<article class="frecuente1">
  ...
  <p> Los mensajes son mensajes privados enviados desde una cuenta de Sloth a otras cuentas de Sloth. Estos mensajes no aparecen en lugares públicos donde los puedan leer otras personas. Puedes iniciar una conversación con cualquier usuario.</p>
</article>
...
<article class="frecuente1">
  ...
  <p>Consulta nuestro articulo sobre como </p> <a href="#">denunciar una cuenta en Sloth </a><p>También te recomendamos que bloquees las cuentas que envian spam o contenido incorrecto.</p>
</article>
<article class="frecuente1">
  <h3>¿Dónde encuentro mas información sobre los Terminos de servicio?</h3>
  <p>Consulta los </p><a href="#">Términos de servicio </a><p>de Sloth y las</p> <a href="#">Reglas de Sloth</a><p> para obtener más información.</p>
</article>
</div>
      </section>
      <footer>
